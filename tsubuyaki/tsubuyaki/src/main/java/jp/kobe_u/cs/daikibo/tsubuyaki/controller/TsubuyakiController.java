...
public class TsubuyakiController {
    ...
    @GetMapping("/search")
    String showTsubuyakiSearch(@ModelAttribute("keywordForm") KeywordForm form ,Model model){
        List<Tsubuyaki> list = ts.getSearchTsubuyaki(form.getKeyword());
        model.addAttribute("tsubuyakiSearch",list);
        model.addAttribute("keywordForm",new KeywordForm());
        return "tsubuyaki_search";
    }


    @ModelAttribute
    KeywordForm setupForm() {
